...
#' 2 column format. This data was randomly generated. Case basis: 10 students in a group discussion questions in a STEM course
#' at a major university.
#'
#' @format A data frame with 451 rows and 2 variables:
#' \describe{
